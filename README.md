...
今回は各人の作業場所から遠隔会議を利用しての開催とします。接続方法はZoomを利用する予定です。接続URLは下記のSlack（申し込みを参照）において告知いたします。

|| イベント概要 |
|---|---|
| **開催場所** | 原則として各自遠隔 |
| **開催日時** | 2020年10月22日（水） |
| **申し込み** | [参加申し込み](https://join.slack.com/t/sysbio-hack/shared_invite/zt-bbih19w5-spe9IPze98aYYZ0lK8v2XA) |
...
今回は各人の作業場所から遠隔会議を利用しての開催とします。接続方法は[Discord](https://discordapp.com/)を利用する予定です。詳しくは下記のSlack（申し込みを参照）において告知いたします。
...
2020年7月30日開催。記念すべき10回目ですが特にセレモニーは行われません。
...
今回は各人の作業場所から遠隔会議を利用しての開催とします。接続方法は[Discord](https://discordapp.com/)を利用する予定です。詳しくは下記のSlackにおいて告知いたします。
...
今回は各人の作業場所から遠隔会議を利用しての開催とします。接続方法については後日下記のSlackにおいて告知いたします。
